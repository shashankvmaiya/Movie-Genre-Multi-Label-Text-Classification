...
<img height=500 src="./Images/results/genres_per_movie.png"/>
...
<div class="row">
  <div class="column">
    <img src="./Images/results/wordcloud_Thriller.png" style="width:60%">
  </div>
  <div class="column">
    <img src="./Images/results/wordcloud_Sport.png" style="width:60%">
  </div>
  <div class="column">
    <img src="./Images/results/wordcloud_War.png" style="width:60%">
  </div>
</div>
